...
def get_image(imageId):
    ...
    fullImagePath3 = '../../data/three_band/' + imageId + '.tif'
    fullImagePathA = '../../data/sixteen_band/' + imageId + '_A.tif'
    fullImagePathM = '../../data/sixteen_band/' + imageId + '_M.tif'
    fullImagePathP = '../../data/sixteen_band/' + imageId + '_P.tif'
